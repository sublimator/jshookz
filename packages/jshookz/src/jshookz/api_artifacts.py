...
REQUIRED_ARTIFACTS = frozenset(
    {
        "packages/jshookz/src/jshookz/types/hooks-api.d.ts",
        "packages/jshookz/src/jshookz/types/xahau-quickjs-v1.d.ts",
        "packages/jshookz/src/jshookz/types/xahau-quickjs-v1.surface.json",
    }
)
V1_DECLARATION = "packages/jshookz/src/jshookz/types/xahau-quickjs-v1.d.ts"
V1_SURFACE = "packages/jshookz/src/jshookz/types/xahau-quickjs-v1.surface.json"
