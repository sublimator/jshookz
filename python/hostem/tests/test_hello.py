...
HOSTEM = Path(__file__).parents[1]
XAHAU_PROVIDER = ROOT / "build" / "xahau-provider" / "jshookz_provider.wasm"
XAHAU_TYPESCRIPT = HOSTEM / "examples" / "xahau-accept.hook.ts"
XAHAU_STATE_TYPESCRIPT = HOSTEM / "examples" / "xahau-state.hook.ts"
XAHAU_STATE_BATCH_TYPESCRIPT = HOSTEM / "examples" / "xahau-state-batch.hook.ts"
