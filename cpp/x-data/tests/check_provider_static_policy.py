...
FORBIDDEN_SOURCE_PATTERNS = {
    ...
    "direct C allocation": r"(?<![.A-Za-z0-9_])(?:(?:std)?::)?(?:malloc|calloc|realloc|aligned_alloc|posix_memalign)\s*\(",
    "direct C deallocation": r"(?<![.A-Za-z0-9_])(?:(?:std)?::)?free\s*\(",
    "bad_alloc route": r"(?:__throw_bad_alloc|\bbad_alloc\b)",
...
FORBIDDEN_SYMBOL_PATTERNS = {
    ...
    "STL string ownership": r"basic_string",
    "STL map/set ownership": r"(?:unordered_(?:map|set)|[0-9]+(?:map|set)[A-ZI])",
    "STL smart-pointer ownership": r"(?:unique_ptr|shared_ptr|make_unique|make_shared)",
...
def run_red_controls(inventory: Path) -> list[str]:
    ...
    for label, pattern in FORBIDDEN_SOURCE_PATTERNS.items():
        sample = {
            ...
            "direct C allocation": "auto value = malloc(64);",
            "direct C deallocation": "free(value);",
            "bad_alloc route": "std::__throw_bad_alloc();",
    ...
    symbol_samples = {
        ...
        "STL string ownership": "__ZNSt3__112basic_stringIcEE",
        "STL map/set ownership": "__ZNSt3__113unordered_mapIiiE",
        "STL smart-pointer ownership": "__ZNSt3__110unique_ptrIiE",
